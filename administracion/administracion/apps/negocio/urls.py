...
urlpatterns = patterns('',
	...
	url(r'^VerCodigoQRr/(?P<id>\d+)/$',VerCodigoQRr),
	...
	url(r'^gegocio_ajax/$',gegocio_ajax),
	url(r'^RegistrarMulta/(?P<id>\d+)/$',RegistrarMulta),
	url(r'^guadarMulta/$',guadarMulta),
	url(r'^VerMultasRegistrdas/(?P<id>\d+)/$',VerMultasRegistrdas),
	
	url(r'^EliminarMultaAA/(?P<id>\d+)/$',deliiMul),
)